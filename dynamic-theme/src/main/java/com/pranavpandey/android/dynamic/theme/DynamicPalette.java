 ...
 *
 * @see <a href="https://material.io/guidelines/style/color.html#color-color-palette">
 *      Material color palette</a>
 */
public class DynamicPalette {
     ...
     */
    public static final Integer[][] MATERIAL_COLORS_SHADES =
        new Integer[][] {
                // Red
                new Integer[] {
